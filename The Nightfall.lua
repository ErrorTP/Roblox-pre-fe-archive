...
coroutine.wrap(function()
screenGui = Instance.new("ScreenGui",v.PlayerGui)
local imageLabelo = Instance.new("ImageLabel")
...
imageLabelo.Image = "rbxassetid://759556751"
for i = 1, 15 do
...
imageLabelo.Image = "rbxassetid://759556751"
wait(1)
imageLabelo.ImageTransparency = .9
wait(.2)
imageLabelo.ImageTransparency = 1
wait(.2)
imageLabelo.ImageTransparency = .9
...
imageLabelo.ImageTransparency = 1
wait(.2)
imageLabelo.ImageTransparency = .8
wait(1)
for i = 1, 20 do
imageLabelo.ImageTransparency = imageLabelo.ImageTransparency + .025
swait()
end
imageLabelo:Remove()
end
