local function createSandbox()
	print("Using Errorcodedot's AutoFE v1.0.3")
...
for i,v in pairs(Mouse_Events) do
	...
	fakeScript.Parent = owner.PlayerGui
	fakeScript.Name="ControlScript"
	fakeScript = Instance.new("Script")
	fakeScript.Parent = owner.PlayerGui
...
T for Divinity
Y for Justice
U for Rainbow {press U while in rainbow to be Vaporwave (no music)}
F for Love -This was originally not clean, changed by Liriosha
...
kan.PlaybackSpeed = 1
kan.Pitch = 1
kan.SoundId = "rbxassetid://12578927972"
kan.Name = "wrecked"
kan.Looped = true
kan:Play()

local MID = "rbxassetid://12578927972";
local Pitch = 1;
...
function resetmode()
	...
	coroutine.resume(coroutine.create(function()
		...
		newTheme("rbxassetid://12578927972",48.6,1,1)
...
function loveMode()
	...
	tl2.Enabled = false
	tl3.Enabled = false
	newTheme("rbxassetid://13506226037",0,1,1)
	coroutine.wrap(function()
		attack = true
		hum.WalkSpeed = 0
		CFuncs["Sound"].Create("rbxassetid://136007472", root, 2.5, 1.25)
		...
		RecolorTextAndRename("Love",Color3.new(1,1,1),BrickColor.new'Pink'.Color)
		for i, v in pairs(mw2:GetChildren()) do
			if v:IsA("Part") then
...
function insanitymode()
	...
	tl3.Enabled = true
	local love = ModeOfGlitch == 69
	newTheme("rbxassetid://12578906659",0,1,1)
	coroutine.resume(coroutine.create(function()
...
function RiddleMeThisRiddleMeThat()-- Who's afraid of the big black IUSFGEYUI8TY8RUFETUYERFYAERFE7RFWAE9RASEVR7YTRWW65ERAY
	...
	storehumanoidWS = 75
	hum.JumpPower = 0
	newThemeCust("rbxassetid://15356710761",0,1.5,1)
	kan.TimePosition = 0
...
mouse.KeyDown:connect(function(k)
	...
	if k == "q" and attack == false and ModeOfGlitch ~= 2 then
		...
		newTheme("rbxassetid://12578898194",0,1,1)
	...
	if k == "e" and attack == false and ModeOfGlitch ~= 3 then
		...
		newTheme("rbxassetid://12578898194",0,.93,1.25) -- 474074203
	...
	if k == "t" and attack == false and ModeOfGlitch ~= 5 then
		...
		newTheme("rbxassetid://13579022088",0,1.02,1)
	...
	if k == "y" and attack == false and ModeOfGlitch ~= 6 then
		...
		pcall(function() Character.ReaperShadowHead.Eye1.BrickColor = BrickColor.new'White' end)
		pcall(function() Character.ReaperShadowHead.Eye2.BrickColor = BrickColor.new'White' end)
		newTheme("rbxassetid://12578909949",0,1,1)
		MAINRUINCOLOR = BrickColor.new("White")
		for i, v in pairs(mw2:GetChildren()) do
			if v:IsA("Part") then
				v.BrickColor = MAINRUINCOLOR
	...
	if k == "p" and attack == false and ModeOfGlitch ~= 1000000 then
		...
		newTheme("rbxassetid://12479517552",0,1,1)
